...
- Afspraken over de betekenis van gegevens. Wat bedoelen we met een Pakket 
...
- Afspraken over toegestane coderingen/codelijsten. Bijvoorbeeld de landencode of de codering voor de ADN Branchecodes
...
- Afspraken over het groeperen van gegevens. Gegevens die bij elkaar horen plaatsen we in dezelfde groep (entiteit). Bijvoorbeeld Verzekeringnemer, Verzekerde.

- Afspraken over het aantal keren dat een groep gegevens mag voorkomen in een bericht. Hoeveel auto’s kunnen op een particuliere polis gesloten worden

- Afspraken over de structuur van gegevens die we uitwisselen in berichten. Als verzekerde objecten herhalen, bij welke objecten horen dan de dekkingen

**Gegevenswoordenboeken overheid**

De NORA biedt een [overzicht van gegevenswoordenboeken](https://www.noraonline.nl/wiki/Gegevenswoordenboeken) in het overheidsdomein.
