---
layout: post
title: "Belangrijke databronnen voor pensioenuitvoerders"
date: 2024-04-24
...
![](https://static.helpjuice.com/helpjuice_production/uploads/upload/image/9209/4005623/20240127_databronnen_-_Attachment_1.png)
...
- Zij kunnen eencurator toegewezen krijgen die de verantwoordelijkheid overneemt. Meer personendan vroeger zijn bevoegd tot het aanvragen van curatele. Dat is aan te vragendoor: betrokkene zelf, zijn echtgenoot/geregistreerde partner of anderelevensgezel, zijn bloedverwanten in de rechte lijn en in de zijlijn tot en metde vierde graad. Andere mogelijke aanvragers zijn: degene die het gezag overhem uitoefent, zijn voogd, bewindvoerder of mentor, het Openbaar Ministerie ende instelling die betrokkene verzorgt of hem begeleidt. Nieuw is dat eenrechtspersoon met volledige rechtsbevoegdheid, bijvoorbeeld een stichting beheercliëntengelden, tot curator kan worden benoemd.

- Wie alleen opfinancieel gebied bescherming nodig heeft, kan een bewindvoerder krijgen dieover het vermogen waakt. Niet alleen mensen met een beperking, maar ook wieverkwistend met zijn geld omgaat of problematische schulden heeft, kan onderbewind worden gesteld.

Via een openbaar toegankelijk register,het Centraal Curatele en Bewind Register (CCBR), kunnen partijen controleren ofeen persoon onder curatele staat van een curator of onder bewind van eenbewindvoerder.

Pensioenuitvoerdershebben te maken met personen die onder curatele staan, dan wel onder bewind.Voor deze deelnemers dient veelal de communicatie en/of betalingen via debewindvoerder te lopen. De curator is de wettelijk vertegenwoordiger van dedeelnemer en mag namens deze deelnemer handelen.

Als pensioenuitvoerdermag je dus persoonlijke informatie delen met de curator of de deelnemer.Hiervoor is het wel noodzakelijk dat de pensioenuitvoerder vooraf wet wie decurator is. Ook ter meer dat de deelnemer dan zelf ook geen beslissingen magnemen, zoals het pensioenaanvragen. Dit zou kunnen resulteren dat hetpensioenfonds alsnog zou de curator moet betalen ondanks dat de betreffendedeelnemer zijn geld heeft gehad, bijvoorbeeld bij een afkoop van het pensioen.
...
- Wanneer deze er niet in voorkomt, krijgt u 0 resultaten. Via delink 'afdrukken verklaring niet voorkomen' kunt u de verklaring downloaden en opslaan.
...
Aanvragen van een abonnement en opvragen van accountgegevens kan via het [abonneeportaal](https://ccbr.rechtspraak.nl/#!/registratie).

Bluem Payment Service
...
- Digitaal veilig ontsluiten van privacygevoelige informatie voor gerechtsdeurwaarders, gemeenten en waterschappen en andere organisaties in het publieke domein.

- Jarenlange expertise op het snijvlak van invordering en informatisering.
...
- controle dat elektronische verzoeken om informatie afkomstig zijn van bevoegde deurwaarders;

- inhoudvan het antwoordbericht e-VOI: o.a.: netto-inkomen, vergoedingen, verrekeningen en beslagen;

- geschikt voor alle periodieke inkomsten (te weten: pensioenen, uitkeringen en alle vormen van dienstverbanden);

- periodieke controleop loonheffingnummers;
...
De deurwaarder maakt op basis van de ontvangen inkomsteninformatie de overweging tot beslaglegging op inkomsten en stelt de beslagvrije voet vast.

De aansluiting op e-VOI is een samenwerking tussen SNG en de informatieverstrekker. Aansluiting is mogelijk vanaf 200 informatieverzoeken per maand. De opstart bestaat uit:

- kennismaking en uitgebreide intake, waaronder het in kaart brengen wijze van technische aansluiting op e-VOI;

- advies over mogelijkheid integratie in bestaande software bij uw organisatie, tenzij deze al is voorbereid;

- aanmelden bij SNG;

- SNG stuurt de benodigde overeenkomsten en documenten;

- Aanleveren getekende overeenkomsten en aanvullende documenten;

- autorisatie op basis van getekende overeenkomsten na toetsing juridische entiteit;

- realiseren system-to-system koppeling, testen en Go Live.

Grote werkgevers, uitkeringsinstanties, uitzendorganisaties en pensioenfondsen maken gebruik van e-VOI. Steeds meer organisaties sluiten aan.

Jaarlijks verwerkt SNG ruim 400.000 verzoeken om informatie o.a. voor diverse grote gemeenten waaronder gemeente Rotterdam en voor grote organisaties als Randstadgroep, APG, UWV.

Alle gerechtsdeurwaarderskantoren in Nederland zijn aangesloten op e-VOI en steeds meer beslagleggende organisaties sluiten aan op e-VOI waaronder gemeenten, gemeenschappelijke regelingen en waterschappen.
